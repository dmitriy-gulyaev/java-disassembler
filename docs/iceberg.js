                            ...
                            if (opCodeFlags[opcode]) {
                                ...
                                case TABLESWITCH: {
                                        ...
                                        for (var pn = 0; pn < offsets; pn++) {
                                            ...
                                            desc2 = desc2 + "" + (pn + _low) + ": go to " + (o + oc) + "<br/>";
                                        }

                                        //alert("def=" + _default + ", low=" + _low + ", high=" + _high + ", dif=" + offsets);
                                        oc = oc + offsets * 4 + 12 + y - 1;
                                        break;
                                    }
                                case LOOKUPSWITCH: {
                                        var y = 1;
                                        ...
                                        for (var pn = 0; pn < _npairs; pn++) {
                                            ...
                                            desc2 = desc2 + "" + mt + ": go to <b>" + (o + oc) + "</b><br/>";
                                        }

                                        //alert("LOOKUPSWITCH " + _npairs);
                                        oc = oc + _npairs * 4 * 2 + 8 + y - 1;
                                        break;
                                    }
                                case WIDE: {
                                        isWide = true;
                    ...
                    if (attributeName != ATTRIBUTES_CODE) {
                        ...
                        if (codeAttributeRecord.exception_table_length > 0) {
                            ...
                            for (var ln = 0; ln < codeAttributeRecord.exception_table_length; ln++) {
                                ...
                                attributeValue = attributeValue + "<tr>" +
                                    "<td>" + lvtt.start_pc + "</td>" +
                                    "<td>" + lvtt.end_pc + "</td>" +
                            ...
                            attributeValue = attributeValue + "</table>";
            ...
            function getAccessModifiers(array, accessFlags) {
                ...
                for (var m = 0; m < array.length; m++) {
                    if (isMaskSet(accessFlags, array[m])) {
                        result = result + "<b class='access'>ACC_" + array[m][0] + "</b>" + " ";
                    }
                }
                return result;
            }
...
*/
                ...
                case CONSTANT_Fieldref:
                    ...
                    if (!isThis) {
                        result = result + getClassName(cpEntry.class_index, false, false, false) + ".";
                    }
                    ...
                    if (cpEntry.tag != CONSTANT_Fieldref) {
                        //result = result + "<span style='background:#ffffaa'><code>" +  + "</code></span>";
                        result = result + "()";
                    }
            ...
            if (classFile.interfaces_count > 0) {
                var intf = "";
                for (var i = 0; i < classFile.interfaces_count; i++) {
                    intf = intf + getArgumentTypeAndValue(classFile.interfaces[i]);
                }
