...
public class CreateOpCodesArray {
  ...
  public static void main(String[] args) {
    ...
    opcodes[182] = new String[] { "in.virt.", CPINDX_16, "Invoke instance method; dispatch based on class" };
    opcodes[183] = new String[] { "in.spec.", CPINDX_16,
        "Invoke instance method; special handling for superclass, private, and instance initialization method invocations" };
    opcodes[184] = new String[] { "in.stat.", CPINDX_16, "Invoke a class (static} method" };
    opcodes[185] = new String[] { "in.intrf.", INVINT_64, "Invoke interface method" };
    opcodes[186] = new String[] { "in.dy.", INVINT_64, "Invoke dynamic method" };
